...
def pushtobase(index):
	...
	specialSeat="occupied"
	train_density_index=2
	payload={"actor": {"displayName": "BARTtrain","id": "2","objectType": "train"},"verb": "checkin","published": startTime,"status": "completed","object": {"displayName":"Car1","dataFields": {"train_length": 1,"train_route": 7,"train_index": 72,"route_start": "SFIA","route_end": "PITT","station_previous": "ROCK","station_next": "ORIN","car_1": {"car_density_index": density,"overcrowded": crowded,"specialSeat":specialSeat}},"objectType": "trainRecord"},"target" : {"url": "http://example.org/blog/","objectType": "blog","id": "tag:example.org,2011:abc123","displayName": "Berkeley"}}
